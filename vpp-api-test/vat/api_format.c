...
_(sw_interface_fip64_add_reply)                         \
_(sw_interface_fip64_del_reply)                         \
_(sw_interface_fip64_sync_enable_reply)                 \
_(sw_interface_fip64_sync_disable_reply)
...
_(SW_INTERFACE_FIP64_ADD_REPLY, sw_interface_fip64_add_reply)           \
_(SW_INTERFACE_FIP64_DEL_REPLY, sw_interface_fip64_del_reply)           \
_(SW_INTERFACE_FIP64_SYNC_ENABLE_REPLY, sw_interface_fip64_sync_enable_reply)\
_(SW_INTERFACE_FIP64_SYNC_DISABLE_REPLY, sw_interface_fip64_sync_disable_reply)
...
//miguel
static int
api_sw_interface_fip64_add (vat_main_t * vam)
{
  unformat_input_t * i = vam->input;
  ...
  M(SW_INTERFACE_FIP64_ADD, sw_interface_fip64_add);
...
static int
api_sw_interface_fip64_del (vat_main_t * vam)
{
  unformat_input_t * i = vam->input;
  ...
  M(SW_INTERFACE_FIP64_DEL, sw_interface_fip64_del);
...
static int
api_sw_interface_fip64_sync_enable (vat_main_t * vam)
{
  unformat_input_t * i = vam->input;
  ...
  M(SW_INTERFACE_FIP64_SYNC_ENABLE, sw_interface_fip64_sync_enable);
...
static int
api_sw_interface_fip64_sync_disable (vat_main_t * vam)
{
  unformat_input_t * i = vam->input;
  ...
  M(SW_INTERFACE_FIP64_SYNC_DISABLE, sw_interface_fip64_sync_disable);
...
/*miguel*/                                                              \
_(sw_interface_fip64_add, "<ip6_fip6> <ip4_fixed4> "                    \
   "[pool <ip4_pool_start> <ip4_pool_end>] [table <n>] [vni <vni>]")    \
_(sw_interface_fip64_del, "<ip6_fip6>")                                 \
_(sw_interface_fip64_sync_enable, "<vrf_id>")                           \
_(sw_interface_fip64_sync_disable, "")
